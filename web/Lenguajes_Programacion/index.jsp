            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            con.setConsulta("select Lenguajes_programacion.lenguaje_id,Lenguajes_programacion.nombre,Lenguajes_programacion.fecha_creacion,Lenguajes_programacion.creador_id as Creadores from Lenguajes_programacion,Creadores where Lenguajes_programacion.creador_id=Creadores.creador_id and Lenguajes_programacion.estado='activo'");
                            out.println("<tr>");
                                    ...
                                    out.println("<td>" + "<a href='../ServletLenguaje_Programacion?eliminar=" + con.getResultado().getString("lenguaje_id") + "'>Eliminar</a>" + "</td>");
                                    out.println("<td>" + "<a href='editar.jsp?lenguaje_id=" + con.getResultado().getString("lenguaje_id") + "'>Editar</a>" + "</td>");
